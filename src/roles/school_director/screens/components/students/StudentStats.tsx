    ...
    <View className="gap-3">
          ...
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center gap-3">
              ...
              <View>
                ...
                <Text className="text-2xl font-extrabold text-gray-900 dark:text-gray-100">{stats.totalStudents}</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center gap-3">
              ...
              <View>
                ...
                <Text className="text-2xl font-extrabold text-gray-900 dark:text-gray-100">{stats.activeStudents}</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      <View className="flex-row gap-3">
        <View className="flex-1 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-4">
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center gap-3">
              <View className="h-10 w-10 items-center justify-center rounded-xl bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300">
                <Ionicons name="close-circle-outline" size={18} color="currentColor" />
              </View>
              <View>
                <Text className="text-gray-500 dark:text-gray-400 text-xs">Inactive</Text>
                <Text className="text-xl font-bold text-gray-900 dark:text-gray-100">{inactiveStudents}</Text>
              </View>
            </View>
          </View>
        </View>
