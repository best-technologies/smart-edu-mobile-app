...
export function StudentCard({ student, isSelected = false, onSelect }: StudentCardProps) {
      ...
      <View className="flex-row items-start gap-3">
        ...
        <View className="flex-1 min-w-0">
          <View className="flex-row items-center justify-between mb-1">
            <View className="flex-1 min-w-0">
              <Text className="text-base font-bold text-gray-900 dark:text-gray-100" numberOfLines={1}>{fullName}</Text>
